          ...
          <div className="tab">
            <div className="bank">
              <div className="text5">
                <h2>Pay ${amount}</h2>
                <p>Make Payment</p>
                <p>{invoice && ` ${invoice} ${cryptoShortForms[selectedCrypto]}`}</p>
              </div>
              ...
              <form>
                ...
                <button
                  ...
                  className="go"
                onClick={() => {
                  navigate(`/${userData.username}/fund/payment/confirmation`, {
                    state: {
                      invoice,
                      plan,
                      amount,
                      selectedCrypto,
                      cryptoShortForm: cryptoShortForms[selectedCrypto], // Pass only the string value
                    },
                  });
